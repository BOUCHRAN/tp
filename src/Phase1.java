...
public class Phase1 {
    ...
    public static void main(String[] args) {
        ...
        Module algoModule = new Module("Algorithmique",mathFiliere,profMath);
        Module calcModule = new Module("Calcul Différentiel",mathFiliere,profMath);
    ...
    private static void ajouterModule() {
        ...
        Module nouveauModule = new Module(nomModule, filiereSelectionnee, enseignantSelectionne);
